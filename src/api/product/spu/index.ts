...
import type { AllTradeMark, HasSaleAttrResponseData, SaleAttrResponseData, SkuData, SkuInfoData, SpuData, SpuHasImg, SpuResponseData } from "./type";
...
export const reqSpuHasSaleAttr = (spuId: number | string) => request.get<any, SaleAttrResponseData>('/admin/product/spuSaleAttrList/' + spuId)
