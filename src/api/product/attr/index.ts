...
export const reqCategory2 = (category1Id: string | number) =>
  request.get<any, CategoryResponseData>(API.GETCATEGORY2_URL + category1Id)
export const reqCategory3 = (category2Id: string | number) =>
...
export const reqCategory = (
  ...
  request.get<any, AttrResponseData>(
    API.GETCATEGORY_URL + `${category1Id}/${category2Id}/${category3Id}`,
  )
